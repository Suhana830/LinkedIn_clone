...
const ProfileHeader = ({ userData, onSave, isOwnProfile }) => {
    ...
    return (
        <div className='bg-white shadow rounded-lg mb-6 text-gray'>
            <div
            ...
            >
                {isEditing && (
                    <label className='absolute top-2 right-2  bg-gray p-2 rounded-full shadow cursor-pointer'>
                        <Camera size={20} />
                        <input
                            type='file'
                            className='hidden'
            ...
            <div className='p-4'>
                ...
                <div className='text-center mb-4 '>
                    {isEditing ? (
                        <input
                            ...
                            className='text-2xl font-bold mb-2 text-center w-full  bg-gray-400 '
                        />
                    ) : (
                    ...
                    {isEditing ? (
                        <input
                            ...
                            className='text-center w-full text-white bg-gray-400'
                        />
                    ) : (
                    ...
                    <div className='flex justify-center items-center mt-2'>
                        ...
                        {isEditing ? (
                            <input
                                ...
                                className='text-gray-600 text-center bg-gray-400'
                            />
                        ) : (
                ...
                {isOwnProfile ? (
                    isEditing ? (
                        <button
                            className='w-full bg-primary text-white py-2 px-4 rounded-full hover:bg-primary-black
